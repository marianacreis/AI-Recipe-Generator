...
function generateRecipe(event) {
  ...
  let prompt = `Write a recipe for lunch or dinner that uses the following ingredients : ${ingredients.value}. The recipe need to have those ingredients mandatorily, but it can also include more ingredients. Please write the answer using basic HTML. The title of the recipe should be in the begining inside a <strong> element. It should be followed by the ingredients list and each ingredient should be separated by a <br/> element. After it should have the cooking instructions inside a <p> element. Please do not add anymore informations, besides the name of the dish, the ingredients and the instructions.  `;
  let context =
