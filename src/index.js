...
function generateRecipe(event) {
  ...
  let prompt = `Write a recipe for lunch or dinner that uses the following ingredients : ${ingredients.value}. Please add more ingredients that you think are necessary for the recipe.  Please write the answer using basic HTML.
